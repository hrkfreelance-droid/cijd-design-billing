...
export function ItemProductionAction({
  ...
  /** Optional workspace-specific label for the physical delivery action. */
  ...
  return (
    <>
      ...
      >
        {finished ? undoLabel : delivery && deliveryLabel ? deliveryLabel : size === "sm" ? (delivery ? t("delivery.markShort") : t("production.completeShort")) : activeLabel}
      </Button>
      <ConfirmSheet
        open={asking}
        onClose={() => setAsking(false)}
