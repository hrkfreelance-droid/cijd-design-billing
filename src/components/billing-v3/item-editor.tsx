        ...
        {costPriced ? (
          <div className="col-span-2 grid grid-cols-2 gap-2 sm:contents">
            ...
            <Field label={t("v2.totalCost")}>
              <ReadOnlyMoney value={draft.totalCost} testId={`v3-item-total-cost-${index}`} />
            </Field>
          </div>
        ) : (
          <>
 ...
 */
function ReadOnlyMoney({ value, testId }: { value: string; testId?: string }) {
  return (
