...
const nextConfig = {
  ...
  distDir,
  // The standalone typecheck remains mandatory; this opt-in bypass avoids
  // Next's duplicate tsconfig reopen on noowners external volumes.
  ...(process.env.CIJD_BUILD_SKIP_TS === "true"
